    ...
    >
      ...
      >
        ...
        <div className={'h-full w-full flex justify-center items-center'}>
          <h3 className={'font-light text-lg desktop:text-3xl mobile:text-xl'}>
      ...
      <Section>
        <Paragraph>
          <p>
            ...
            with wolves and he's sexualizing canines, which are the fundamental
            principles of a furry "enthusiast".
          </p>
          <p>
        ...
        <Paragraph>
          <p>
            ...
            believe it was Hinata or something, and how he views her as sexually
            attractive.
          </p>
          <p>
            normally this is acceptable but no it is not, and as a resident
            snowflake tasked with gatekeeping humor, i shall not stand for this.
          </p>
        </Paragraph>
        <Paragraph>
          <p>
        ...
        <div className={'flex flex-1 flex-row gap-6 w-full'}>
          ...
          <Paragraph>
            <p>
              ...
              imagine reading this entire "article", if you can call it that, I
              spent like 3 hours on it.
            </p>
          </Paragraph>
        </div>
      </Section>
